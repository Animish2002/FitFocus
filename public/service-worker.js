...
self.addEventListener('push', function(event) {
  ...
  const options = {
    ...
    icon: data.icon || 'https://res.cloudinary.com/dkv3bx51z/image/upload/v1753765682/FitFocus_da7uvi.png', // Default icon
    badge: data.badge || 'https://res.cloudinary.com/dkv3bx51z/image/upload/v1753765772/bell_l81cml.png', // Small icon for notification tray on some OS
    data: {
